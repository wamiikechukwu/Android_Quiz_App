...
public class cardViewTwo extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_card_view_two);

        ImageView imageView = findViewById(R.id.didyouknow2);
        Glide.with(this).load(R.drawable.didyouknow2).into(imageView);
