...
public class cardViewSix extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_card_view_six);

        ImageView imageView = findViewById(R.id.didyouknow6);
        Glide.with(this).load(R.drawable.didyouknow6).into(imageView);
    }
